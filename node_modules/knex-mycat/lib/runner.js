...
Runner.prototype._beginTransaction = 'set autocommit=0;';
Runner.prototype._commitTransaction = 'commit;';
Runner.prototype._rollbackTransaction = 'rollback;';
Runner.prototype._endTransaction = 'set autocommit=1;';
...
Runner.prototype.commitTransaction = function() {
  return this._commitTransaction   && this.query({sql: this._commitTransaction}) && this.query({sql: this._endTransaction});
};
Runner.prototype.rollbackTransaction = function() {
  return this._rollbackTransaction && this.query({sql: this._rollbackTransaction}) && this.query({sql: this._endTransaction});
};
Runner.prototype.endTransaction = function() {
    return this._endTransaction && this.query({sql: this._endTransaction});
};
